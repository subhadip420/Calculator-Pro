...
class ForceConverterView extends StatefulWidget {
  final VoidCallback onBack;

  const ForceConverterView({super.key, required this.onBack});

  @override
  State<ForceConverterView> createState() => _ForceConverterViewState();
}
...
class _ForceConverterViewState extends State<ForceConverterView> {
  ...
  String fromUnit = 'Kilogram force';
  String fromSymbol = 'kgf';
  String fromValue = '1';

  String toUnit = 'Newton';
  String toSymbol = 'N';
  String toValue = '9.80665';

  late TextEditingController _fromController;
  late TextEditingController _toController;

  // --- MATH LOGIC: Base is 1 Newton (N) ---
  final Map<String, double> forceConversionRates = {
    'Newton': 1.0,
    'Kilonewton': 1000.0,
    'Meganewton': 1000000.0,
    'Giganewton': 1000000000.0,
    ...
    'Short ton force': 8896.443230521,
    'Long ton force': 9964.0164181835,
    'Dyne': 0.00001,
  };
  ...
  void _calculateConversion() {
    double rateFrom = forceConversionRates[fromUnit] ?? 1.0;
    double rateTo = forceConversionRates[toUnit] ?? 1.0;
  ...
  void _showUnitPicker(bool isFrom) async {
    ...
    final selectedUnit = await showModalBottomSheet<Map<String, String>>(
      ...
      builder: (context) {
        return const UnitSelectorSheet(category: 'Force');
      },
    );
